...
const enTranslations = {
    ...
    networkCountryLabel: "Network Country",
    networkRegionLabel: "Network Region",
    networkMetaHint: "Optional explicit network metadata for consistency checks. Example country: JP, region: asia",
